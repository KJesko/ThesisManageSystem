...
<!--            <el-badge v-if="messageNum>0" :value="messageNum" :max="99" class="message-badge" type="danger">-->
<!--              <el-button class="message">-->
<!--                <el-icon><Message /></el-icon>-->
<!--              </el-button>-->
<!--            </el-badge>-->
<!--            <el-badge v-else class="message-badge" type="danger">-->
<!--              <el-button class="message">-->
<!--                <el-icon><Message /></el-icon>-->
<!--              </el-button>-->
<!--            </el-badge>-->
...
<!--                  <el-dropdown-item command="test"> {{ item[0] }} </el-dropdown-item>-->
<!--                </div>-->
<!--              </el-dropdown-menu>-->
<!--            </template>-->
<!--          </el-dropdown>-->
...
export default defineComponent({
  ...
  setup() {
    ...
    const nickname = computed(() => JSON.parse(localStorage.getItem('userInfo') as string)?.uid ?? 'unknown')
