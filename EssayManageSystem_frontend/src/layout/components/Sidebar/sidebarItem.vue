...
export default defineComponent({
  ...
  setup(props) {
    ...
    // 这里加进if可以隐藏侧边栏选择
    if (basePath.value.startsWith('/home') || basePath.value.startsWith('/dashboard')
     || basePath.value.startsWith('/Role') || basePath.value.startsWith('/personal')
     ){
      props.item.meta.hidden = true
    }
